...
namespace PracticaComentarioAPI
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\dotel\OneDrive - Instituto Tecnológico de Las Américas (ITLA)\Cuatrimestres\6toCuatri\Mirenia de Datos\Practica1Mineria.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.06581997F,L2Regularization=0.79494846F,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}))      
